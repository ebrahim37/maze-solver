...
Web demo available [here](http://ebrahim37.github.io/maze-solver/), you can use sample mazes from [here](https://github.com/ebrahim37/maze-solver/tree/master/sample%20mazes).
